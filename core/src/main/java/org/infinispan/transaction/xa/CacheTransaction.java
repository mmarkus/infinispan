...
public interface CacheTransaction {
   ...
   /**
    * @see org.infinispan.interceptors.locking.OptimisticLockingInterceptor#lockKeyAndCheckOwnership(org.infinispan.context.InvocationContext, Object, boolean, Integer)
    */
    ...
    * @see org.infinispan.interceptors.locking.OptimisticLockingInterceptor#lockKeyAndCheckOwnership(org.infinispan.context.InvocationContext, Object, boolean, Integer)
    */
   boolean waitForTransactionsToFinishIfHasLock(Object key, long lockAcquisitionTimeout) throws InterruptedException;
}
