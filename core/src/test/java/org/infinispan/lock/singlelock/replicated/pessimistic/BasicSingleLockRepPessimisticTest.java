...
import org.infinispan.lock.singlelock.AbstractBasicTest;
...
public class BasicSingleLockRepPessimisticTest extends AbstractBasicTest {

   public BasicSingleLockRepPessimisticTest() {
      super(Configuration.CacheMode.REPL_SYNC, LockingMode.PESSIMISTIC, false);
   }

   protected void testTxAndLockOnDifferentNodes(AbstractBasicTest.Operation operation, boolean addFirst, boolean removed) throws Exception {
