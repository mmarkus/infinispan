 ...
 */
@Test
public abstract class AbstractBasicTest extends MultipleCacheManagersTest {

   protected Configuration.CacheMode cacheMode;
   protected LockingMode lockingMode;
   protected Boolean useSynchronization;

   protected AbstractBasicTest(Configuration.CacheMode cacheMode, LockingMode lockingMode, Boolean useSynchronization) {
